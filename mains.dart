...
void main() {
// List anrd_stdnt=["jawad","sajjad","ali raza","SULTAN","NOMAN","SHEIRAZ"];

// print(anrd_stdnt);

// List stdnt2=["jawad","roll no",[21,26,16,4,21],34];
...
else if (pass.codeUnitAt(0)>=65 && pass.codeUnitAt(0)<=90 || pass.codeUnitAt(0)>=97 &&pass.codeUnitAt(0)<=122) 
{
